...
public class NullReply<I extends WritableComparable,
  ...
  private static final Logger LOG =
      Logger.getLogger(NullReply.class);

  private static final Byte zeroByte = 0;

  @Override
  public Type getType() {
    return Type.MINIMAL_REPLY;
  }
  /**
  ...
  public void doRequest(ServerData<I, V, E, M> serverData,
    ...
    LOG.debug("doRequest() was called.");
    if (ctx == null) {
      LOG.debug("ChannelHandlerContext is null: assuming local - ignoring.");
      return;
    }
    if (ctx != null) {
