 ...
 */
public class WorkerSaslServerHandler<I extends WritableComparable,
    V extends Writable, E extends Writable, M extends Writable> extends
    SaslServerHandler<WorkerRequest<I, V, E, M>> {
   ...
   */
  public WorkerSaslServerHandler(ServerData<I, V, E, M> serverData,
  ...
  public static class Factory<I extends WritableComparable,
    ...
    public SaslServerHandler newHandler(
        WorkerRequestReservedMap workerRequestReservedMap,
        Configuration conf) {
      return new WorkerSaslServerHandler<I, V, E,
